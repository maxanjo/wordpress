...
function webove_custom_settings(){
	...
	register_setting('options_settings', 'web_logo_text');
	...
	add_settings_field('general-logo_text', __('Logo text', 'webove'), 'webove_general_logo_text', 'my_theme', 'webove-general-options');
	//Logo Footer
...
function webove_general_logo_text(){
	$logo_text = get_option('web_logo_text');
	echo '<textarea rows="8"  class="logo_text"  name="web_logo_text" value="' . $logo_text . '" >' . $logo_text . '</textarea>';
}
