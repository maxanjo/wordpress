...
function webove_custom_settings(){
	...
	add_settings_section('webove-general-css', 'Css Options', 'webove_general_css_page', 'my_theme_css');
	...
	//Custom css
	add_settings_field('general-css', 'insert your Custom Css', 'webove_general_css', 'my_theme_css', 'webove-general-css');
	//Logo
...
function webove_general_css_page(){
	echo 'Write your own styles in the form below:';
}
...
function webove_general_logo(){
	...
	<input type="button" value="Remove Logo" class="button button-danger remove-logo" id="remove-button-logo">
...
function webove_general_logo_footer(){
	...
	<input type="button" value="Remove Footer Logo" class="button button-secondary remove-logo-footer button-danger">
	<input type="hidden" id="logo-footer" name="web_logo_footer" value="' . $logo_footer . '" >
	<p class="description">If your theme support footer logo, please upload it here</p>
	';
...
function webove_general_favicon(){
	...
	echo '
		...
		<input type="button" value="Remove Favicon" class="button  button-secondary button-danger remove-favicon" id="remove-button-favicon">
