...
function web_load_admin_scripts($current_){
	...
	if('toplevel_page_my_theme' == $current_){
		...
		wp_enqueue_style('web-admin');
			...
			wp_register_style('web-admin', get_template_directory_uri() . '/inc/css/template.admin.css', array(), '1.0.0', 'all');
			wp_enqueue_style('web-admin');
			wp_register_script('web-palete-color', get_template_directory_uri() . '/inc/js/libs/palette-color-picker/palette-color-picker.min.js', '1.0.0', true);
			wp_enqueue_script('web-palete-color');
			wp_register_style('web-palette-color', get_template_directory_uri() . '/inc/css/palette-color-picker.css', array(), '1.0.0', 'all');
			wp_enqueue_style('web-palette-color');
			wp_register_script('web-color-picker-settings', get_template_directory_uri() . '/inc/js/color-picker.js', '1.0.0', true);
			wp_enqueue_script('web-color-picker-settings');
		}
		else{return;};
	}
